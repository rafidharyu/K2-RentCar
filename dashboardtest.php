            ...
            <div class="mt-7">
                ...
                <div class="flex mb-16">
                    ...
                    <div class="bg-white shadow-lg rounded-lg max-w-sm">
                        <div class="bg-gray-200 rounded-t-lg px-7 py-10 flex justify-center items-center">
                          <img src="src/assets/img/mobil/Lexus CT 200h.svg" alt="lexuz" class="w-96 h-48">
                        </div>
                        <div class="p-6">
                          <div class="flex items-center justify-between mb-2">
                            <h2 class="text-xl font-semibold text-dongker">Lexus CT200H</h2>
                            <div class="flex items-center space-x-1 text-gray-600">
                              <span class="inline-block w-5 h-5 justify-center items-center">
                                <img src="src/assets/img/mobil/unit.png" alt="units">
                              </span>
                              <span>5 Unit</span>
                            </div>
                          </div>
                          <div class="flex justify-between items-center mb-6">
                            <div class="text-dongker text-2xl font-bold">Rp 500k<span class="font-normal text-abu text-sm">/Day</span></div>
                            <div class="flex items-center space-x-0.5 text-gray-600">
                              <span class="inline-block w-5 h-5 justify-center items-center">
                                <img src="src/assets/img/mobil/seat.png" alt="seats">
                              </span>
                              <span>5 Seats</span>
                            </div>
                          </div>
                          <button class="w-full py-4 border-2 border-dongker text-dongker font-medium hover:bg-gray-300 hover:text-dongker transition duration-300"><a
                            href="Details.html">See Details</a></button>
                        </div>
                    </div>

                    <!-- Kedua  -->
                    <div class="bg-white shadow-lg rounded-lg max-w-sm mx-7">
                        <div class="bg-gray-200 rounded-t-lg px-7 py-10 flex justify-center items-center">
                          <img src="src/assets/img/mobil/Marcedes Benz.svg" alt="Marcedes Benz" class="w-96 h-48">
                        </div>
                        <div class="p-6">
                          <div class="flex items-center justify-between mb-2">
                            <h2 class="text-xl font-semibold text-dongker">Marcedes Benz</h2>
                            <div class="flex items-center space-x-1 text-gray-600">
                              <span class="inline-block w-5 h-5 justify-center items-center">
                                <img src="src/assets/img/mobil/unit.png" alt="units">
                              </span>
                          ...
                          <div class="flex justify-between items-center mb-6">
                            <div class="text-dongker text-2xl font-bold">Rp 990k<span class="font-normal text-abu text-sm">/Day</span></div>
                            <div class="flex items-center space-x-0.5 text-gray-600">
                              <span class="inline-block w-5 h-5 justify-center items-center">
                                <img src="src/assets/img/mobil/seat.png" alt="seats">
                              </span>
                    ...
                    <div class="bg-white shadow-lg rounded-lg">
                        <div class="bg-gray-200 rounded-t-lg px-7 py-10 flex justify-center items-center">
                          <img src="src/assets/img/mobil/Jaguar F-Pace.svg" alt="Marcedes Benz" class="w-96 h-48">
                        </div>
                        <div class="px-6 pt-6">
                          <div class="flex items-center justify-between mb-2">
                            <h2 class="text-xl font-semibold text-dongker">Jaguar F-Pace</h2>
                            <div class="flex items-center space-x-1 text-gray-600">
                              <span class="inline-block w-5 h-5 justify-center items-center">
                                <img src="src/assets/img/mobil/unit.png" alt="units">
                              </span>
                          ...
                          <div class="flex justify-between items-center mb-6">
                            <div class="text-dongker text-2xl font-bold">Rp 750k<span class="font-normal text-abu text-sm">/Day</span></div>
                ...
                <div class="text-center pb-16">
                    <a href="SeeAll.html" class="text-base font-semibold text-white bg-merah py-5 px-7 hover:shadow-lg hover:opacity-80 duration-300 ease-in-out">See All</a>
                </div> 
